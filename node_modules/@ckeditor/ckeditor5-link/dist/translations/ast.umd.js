...
( e => {
const { [ 'ast' ]: { dictionary, getPluralForm } } = {"ast":{"dictionary":{"Unlink":"Desenllazar","Link":"Enllazar","Link URL":"URL del enllaz","Link URL must not be empty.":"","Link image":"","Edit link":"","Open link in new tab":"","This link has no URL":"","Open in a new tab":"","Downloadable":"","Create link":"","Move out of a link":"","Scroll to target":""},getPluralForm(n){return (n != 1);}}};
