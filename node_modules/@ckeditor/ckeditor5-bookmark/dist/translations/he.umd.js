...
( e => {
const { [ 'he' ]: { dictionary, getPluralForm } } = {"he":{"dictionary":{"Bookmark":"סימניה","Insert":"הכנס","Update":"עדכן","Edit bookmark":"ערכו סימניה","Remove bookmark":"הסירו סימניה","Bookmark name":"שם הסימניה","Enter the bookmark name without spaces.":"הקלידו את שם הסימניה ללא רווחים.","Bookmark must not be empty.":"לא ניתן שהסימניה תהיה ריקה","Bookmark name cannot contain space characters.":"שם הסימניה לא יכול להכיל רווחים","Bookmark name already exists.":"שם הסימניה כבר קיים","bookmark widget":"יישומון הסימניה"},getPluralForm(n){return (n != 1);}}};
