...
( e => {
const { [ 'nl' ]: { dictionary, getPluralForm } } = {"nl":{"dictionary":{"Bookmark":"Bladwijzer","Insert":"Invoegen","Update":"Update","Edit bookmark":"Bladwijzer bewerken","Remove bookmark":"Bladwijzer verwijderen","Bookmark name":"Naam van de bladwijzer","Enter the bookmark name without spaces.":"Voer de naam van de bladwijzer in zonder spaties.","Bookmark must not be empty.":"Bladwijzer mag niet leeg zijn.","Bookmark name cannot contain space characters.":"Naam van de bladwijzer mag geen spaties bevatten.","Bookmark name already exists.":"Naam van de bladwijzer bestaat al.","bookmark widget":"bladwijzer widget"},getPluralForm(n){return (n != 1);}}};
