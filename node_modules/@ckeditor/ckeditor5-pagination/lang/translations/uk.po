...
msgstr "Номер поточної сторінки (від 1 до %0)"
...
msgstr "Натискання клавіш для навігації документами"
...
msgstr "Перейти на попередню сторінку (також перемістити вибір)"
...
msgstr "Перейти на наступну сторінку (також перемістити вибір)"
