    ...
    <table class="table table-xs table-pin-rows">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="flex">
            <div class="gap-1">
              ...
              <x-icon-btn-delete class="{{($current_step ==='Closed' || $current_step ==='Cancelled') ? 'btn-disabled' :'' }}" wire:click="delete({{ $value->id }})"
        ...
        <tr class="text-center">
          <th colspan="5"><span class="text-transparent bg-clip-text bg-gradient-to-r from-rose-500 to-orange-500">
