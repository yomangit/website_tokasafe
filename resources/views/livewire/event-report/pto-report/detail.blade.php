<div>
    ...
    <form wire:submit.prevent='store' >
        <div wire:target='store' wire:loading.class="skeleton">
            <div wire:target="store" wire:loading.class="skeleton" class=" left-0 rounded-sm border border-slate-300 p-1 mb-1">
            ...
            {{-- OBSERVER --}}
            <div role="tablist" class="tabs tabs-lifted mb-4 mx-2">
                ...
                <div role="tabpanel" class="tab-content bg-base-100 border-base-300 rounded-box p-6 ">
                        ...
                        <div class="w-full max-w-xs sm:max-w-sm xl:max-w-xl form-control">
                            ...
                            <div class="dropdown dropdown-end">
                                <x-input-search-with-error placeholder="search name" wire:model.live='name_observer'  
                                    :error="$errors->get('name_observer')" :step="$disable_input" tabindex="0"
                                    role="button"  />
                                <div tabindex="0"
                    ...
                    <div class="card   bg-base-100 mt-2 ">
                        <div class="card-body border p-2 border-gray-300 rounded-box">
                            <label
                            class=" text-sm font-extrabold text-transparent divider divider-info bg-clip-text bg-gradient-to-r from-rose-500 to-orange-500">
                            Observer Team</label>
                ...
                <div role="tabpanel" class="tab-content bg-base-100 border-base-300 rounded-box p-6">
                    <div class="grid gap-1 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div class="w-full max-w-xs sm:max-w-sm xl:max-w-xl form-control">
                            ...
                            <div class="dropdown dropdown-end">
                                <x-input-search-with-error placeholder="search Supervisor" :step="$disable_input"
                                    wire:model.live='supervisor_area' :error="$errors->get('supervisor_area')"
                                    class="cursor-pointer read-only:bg-gray-200 "  tabindex="0"
                                    role="button" />
                                <div tabindex="0"
                                    class="dropdown-content card card-compact  bg-base-300 text-primary-content z-[1] w-full  p-2 shadow">
                                    <div class="relative">
                        ...
                        <div class="w-full max-w-md xl:max-w-xl form-control">
                            ...
                            <fieldset   @if ($disable_input) disabled @endif
                                ...
                                <input wire:model.live="type_of_observation" name="radio-10-a" id="new"
                                    class="radio-xs peer/new checked:bg-emerald-500 radio" type="radio" name="status"
                                    value="New" />
                                <label for="new"
                                    class="text-xs font-semibold peer-checked/new:text-emerald-500">{{ __('New') }}</label>

                                <input wire:model.live="type_of_observation" name="radio-10-a" id="no"  
                        ...
                        <div class="w-full max-w-md xl:max-w-xl form-control">
                            ...
                            <fieldset  @if ($disable_input) disabled @endif
                                ...
                                <input wire:model.live="scope_of_observation" name="radio-11-a" id="Partial"
                                ...
                                <input wire:model.live="scope_of_observation" name="radio-11-a" id="Full"
                        ...
                        <div class="w-full max-w-md xl:max-w-xl form-control">
                            ...
                            <fieldset  @if ($disable_input) disabled @endif
                                ...
                                <input wire:model.live="job_guidance" name="radio-12-a" id="JSEA"
                                ...
                                <input wire:model.live="job_guidance" name="radio-12-a" id="SOP"
                    ...
                    <fieldset class=" p-[2px] gap-1" @if ($disable_input) disabled @endif>
                        ...
                        <div class="flex items-center gap-1 pb-2">
                            <input wire:model.live="type_of_activities" name="radio-13" id="draft"
                                class="radio-xs peer/draft checked:bg-indigo-500 radio" type="radio"
                            ...
                            <table class="table table-xs ">
                                ...
                                <tbody>
                                    <tr
                                        ...
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='step_of_the_task_in_correct_order' type="radio"
                                    ...
                                    <tr
                                        ...
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='all_task_steps_are_followed' type="radio"
                                    ...
                                    <tr
                                        ...
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='worker_qualification' type="radio"
                                    ...
                                    <tr class="@error('no_of_worker') border-rose-500 border-2  @enderror">
                                        ...
                                        <td class="text-center"><input @if ($disable_input) disabled @endif wire:model.live='no_of_worker' type="radio"
                                    ...
                                    <tr class="@error('appropriate_ppe') border-rose-500 border-2  @enderror">
                                        ...
                                        <td class="text-center"><input @if ($disable_input) disabled @endif wire:model.live='appropriate_ppe'
                                    ...
                                    <tr
                                        ...
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='work_permit_completed' value="yes"
                                                type="radio" name="radio-4"
                                                class="radio radio-xs checked:bg-blue-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='work_permit_completed' value="no"
                                                type="radio" name="radio-4"
                                                class="radio radio-xs checked:bg-rose-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='work_permit_completed' value="n/a"
                                                type="radio" name="radio-4"
                                                class="radio radio-xs checked:bg-gray-500" /></td>
                                    </tr>
                                    <tr
                                        ...
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='take5_completed' value="yes" type="radio"
                                                name="radio-5" class="radio radio-xs checked:bg-blue-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='take5_completed' value="no" type="radio"
                                                name="radio-5" class="radio radio-xs checked:bg-rose-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='take5_completed' value="n/a" type="radio"
                                    ...
                                    <tr
                                        ...
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='pre_job_safety_talk_conductd_properly'
                            ...
                            <table class="table table-xs text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr class="@error('in_good_condition') border-rose-500 border-2  @enderror">
                                        ...
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='in_good_condition' value="yes" type="radio"
                                                name="radio-7-a" class="radio radio-xs checked:bg-blue-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='in_good_condition' value="no" type="radio"
                                                name="radio-7-a" class="radio radio-xs checked:bg-rose-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='in_good_condition' value="n/a" type="radio"
                                    ...
                                    <tr
                                        ...
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='used_properly_and_appropriately' value="yes"
                                                type="radio" name="radio-7-b"
                                                class="radio radio-xs checked:bg-blue-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='used_properly_and_appropriately' value="no"
                                                type="radio" name="radio-7-b"
                                                class="radio radio-xs checked:bg-rose-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='used_properly_and_appropriately' value="n/a"
                                                type="radio" name="radio-7-b"
                                                class="radio radio-xs checked:bg-gray-500" /></td>
                                    </tr>
                                    <tr
                                        ...
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='communication_among_worker_properly'
                                    ...
                                    <tr class="@error('adequate_supervision') border-rose-500 border-2  @enderror">
                                        ...
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='adequate_supervision' value="yes"
                                                type="radio" name="radio-9"
                                                class="radio radio-xs checked:bg-blue-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='adequate_supervision' value="no"
                                                type="radio" name="radio-9"
                                                class="radio radio-xs checked:bg-rose-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='adequate_supervision' value="n/a"
                                                type="radio" name="radio-9"
                                                class="radio radio-xs checked:bg-gray-500" /></td>
                                    </tr>
                                    <tr
                                        ...
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='sufficient_time_to_work_safely' value="yes"
                                                type="radio" name="radio-10"
                                                class="radio radio-xs checked:bg-blue-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='sufficient_time_to_work_safely' value="no"
                                                type="radio" name="radio-10"
                                                class="radio radio-xs checked:bg-rose-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='sufficient_time_to_work_safely' value="n/a"
                                                type="radio" name="radio-10"
                                                class="radio radio-xs checked:bg-gray-500" /></td>
                                    </tr>
                                    <tr
                                        ...
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='housekeeping_maintained_during_performing_the_task'
                                    ...
                                    <tr
                                        ...
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='job_conducted_safely_as_plan' value="yes"
                                                type="radio" name="radio-12"
                                                class="radio radio-xs checked:bg-blue-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='job_conducted_safely_as_plan' value="no"
                                                type="radio" name="radio-12"
                                                class="radio radio-xs checked:bg-rose-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='job_conducted_safely_as_plan' value="n/a"
                                                type="radio" name="radio-12"
                                                class="radio radio-xs checked:bg-gray-500" /></td>
                                    </tr>
                            ...
                            <table class="table table-xs ">
                                ...
                                <tbody>
                                    <tr
                                        ...
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='still_valid_not_expired_1' value="yes"
                                                type="radio" name="radio-1-2"
                                                class="radio radio-xs checked:bg-blue-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='still_valid_not_expired_1' value="no"
                                                type="radio" name="radio-1-2"
                                                class="radio radio-xs checked:bg-rose-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='still_valid_not_expired_1' value="n/a"
                                                type="radio" name="radio-1-2"
                                                class="radio radio-xs checked:bg-gray-500" /></td>
                                    </tr>
                                    <tr
                                        ...
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='steps_of_the_task_in_correct_order' value="yes"
                                                type="radio" name="radio-2-2"
                                                class="radio radio-xs checked:bg-blue-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='steps_of_the_task_in_correct_order' value="no"
                                                type="radio" name="radio-2-2"
                                                class="radio radio-xs checked:bg-rose-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='steps_of_the_task_in_correct_order' value="n/a"
                                                type="radio" name="radio-2-2"
                                                class="radio radio-xs checked:bg-gray-500" /></td>
                                    </tr>
                                    <tr
                                        ...
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='all_hazards_identified' value="yes"
                                                type="radio" name="radio-3-2"
                                                class="radio radio-xs checked:bg-blue-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='all_hazards_identified' value="no"
                                                type="radio" name="radio-3-2"
                                                class="radio radio-xs checked:bg-rose-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='all_hazards_identified' value="n/a"
                                                type="radio" name="radio-3-2"
                                                class="radio radio-xs checked:bg-gray-500" /></td>
                                    </tr>
                            </table>
                            ...
                            <table class="table table-xs text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr
                                        ...
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='all_hazards_adequately_controlled' value="yes"
                                                type="radio" name="radio-4-2"
                                                class="radio radio-xs checked:bg-blue-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='all_hazards_adequately_controlled' value="no"
                                                type="radio" name="radio-4-2"
                                                class="radio radio-xs checked:bg-rose-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='all_hazards_adequately_controlled' value="n/a"
                                                type="radio" name="radio-4-2"
                                                class="radio radio-xs checked:bg-gray-500" /></td>
                                    </tr>
                                    <tr
                                        ...
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='align_with_referred_sop_or_cop' value="yes"
                                                type="radio" name="radio-5-2"
                                                class="radio radio-xs checked:bg-blue-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='align_with_referred_sop_or_cop' value="no"
                                                type="radio" name="radio-5-2"
                                                class="radio radio-xs checked:bg-rose-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='align_with_referred_sop_or_cop' value="n/a"
                                                type="radio" name="radio-5-2"
                                                class="radio radio-xs checked:bg-gray-500" /></td>
                                    </tr>
                                    <tr
                                        ...
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='any_other_effective_work_method' value="yes"
                                                type="radio" name="radio-6-2"
                                                class="radio radio-xs checked:bg-blue-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='any_other_effective_work_method' value="no"
                                                type="radio" name="radio-6-2"
                                                class="radio radio-xs checked:bg-rose-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='any_other_effective_work_method' value="n/a"
                                                type="radio" name="radio-6-2"
                                                class="radio radio-xs checked:bg-gray-500" /></td>
                                    </tr>
                            </table>
                            ...
                            <table class="table table-xs ">
                                ...
                                <tbody>
                                    <tr
                                        ...
                                        <th>1</th>
                                        <td class="text-left">Still valid, Not Expired</td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='still_valid_not_expired_2' value="yes"
                                                type="radio" name="radio-1-3"
                                                class="radio radio-xs checked:bg-blue-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='still_valid_not_expired_2' value="no"
                                                type="radio" name="radio-1-3"
                                                class="radio radio-xs checked:bg-rose-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='still_valid_not_expired_2' value="n/a"
                                                type="radio" name="radio-1-3"
                                                class="radio radio-xs checked:bg-gray-500" /></td>
                                    </tr>
                                    <tr
                                        ...
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='specific_and_controlled' value="yes"
                                                type="radio" name="radio-2-3"
                                                class="radio radio-xs checked:bg-blue-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='specific_and_controlled' value="no"
                                                type="radio" name="radio-2-3"
                                                class="radio radio-xs checked:bg-rose-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='specific_and_controlled' value="n/a"
                                                type="radio" name="radio-2-3"
                                                class="radio radio-xs checked:bg-gray-500" /></td>
                                    </tr>
                            </table>
                            ...
                            <table class="table table-xs text-center">
                                ...
                                <tbody>
                                    <tr
                                        ...
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='adequately_convered_the_jsea' value="yes"
                                                type="radio" name="radio-3-3"
                                                class="radio radio-xs checked:bg-blue-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='adequately_convered_the_jsea' value="no"
                                                type="radio" name="radio-3-3"
                                                class="radio radio-xs checked:bg-rose-500" /></td>
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='adequately_convered_the_jsea' value="n/a"
                                                type="radio" name="radio-3-3"
                                                class="radio radio-xs checked:bg-gray-500" /></td>
                                    </tr>
                                    <tr
                                        ...
                                        <td><input @if ($disable_input) disabled @endif wire:model.live='still_appropriate_to_current_condition'
                                    ...
                                    <tr>
                                        ...
                                        @foreach ($risk_likelihood->RiskConsequence()->get() as $risk_consequence)
                                            <th class=" p-0 text-xs font-semibold text-center border-2 border-black {{$opacity}}">
                                                <label
                                                    @if($disable_btn) @else wire:click="riskId({{ $risk_likelihood->id }}, {{ $risk_consequence->id }},{{ $TableRisk->where('risk_likelihood_id', $risk_likelihood->id)->where('risk_consequence_id', $risk_consequence->id)->first()->risk_assessment_id }})" @endif
                                                    class="btn p-0 mt-1 btn-block btn-xs {{ $disable_btn }} @if (
                                                        $tablerisk_id ==
