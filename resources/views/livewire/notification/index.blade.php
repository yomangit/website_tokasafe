<div>
    <div class="dropdown dropdown-end">
        ...
        <div tabindex="0"
            class=" z-[1] card card-compact dropdown-content w-56  lg:w-96 min-h-3/6 d sm:w-8/12 sm:min-h-3/6 md:w-7/12 md:min-h-2.5/6  lg:min-h-2.5/6 xl:w-4/12 xl:min-h-2.5/6 2xl:w-3.5/12 2xl:min-h-4/6 bg-base-100 shadow">
